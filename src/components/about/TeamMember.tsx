...
const TeamMember = ({ row, col } : { row: string, col: string } ) => {
  ...
  return (
    <div className={`flex items-center justify-center h-60 w-60 rounded-full bg-orange ${col} ${row} -rotate-45 cursor-pointer`} onMouseOver={() => setToggle(false)} onMouseLeave={() => setToggle(true)}>
