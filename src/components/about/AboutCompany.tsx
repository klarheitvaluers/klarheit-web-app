...
const AboutCompany = () => {
  return (
    <div className="w-[90%] h-[90vh] mb-10 mt-6 rounded-3xl shadow-surround dark:shadow-none dark:bg-gradient-to-br dark:from-black dark:to-grey-light p-[60px] relative overflow-hidden">
      <WhyUs/>
